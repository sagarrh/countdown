...
import CustomOption from '../select/CustomOptions';
import { BackgroundOption,BackgroundOptions,CountdownStyle } from '@/src/types/BackgroundOptions';
...
const Settings = () => {
  ...
  return (
    ...
    <button
      ...
      {visible && (
        <div className={`absolute flex flex-col gap-1 md:w-1/2 lg:w-1/4 max-w-md top-16 left-4 md:right-4 backdrop-filter backdrop-blur-lg border border-neutral-800 p-4 mt-2 rounded-lg z-10`}>
            <Label text="dete">
          <input
            type="date"
        ...
        <Label text="style">
          <Select
            ...
            options={CountdownStyle.map((style) => {
              return {
                value: style,
                label: style,
              };
        ...
        <div className="block text-neutral-300 text-xs font-apple2mono mt-4">
          ...
          <ul className="list-disc pl-5">
            ...
            <li>you can set this as your new tab</li>
          </ul>
        </div>
        </div>
      )}
